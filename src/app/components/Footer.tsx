  ...
  return (
    <footer className="bg-black text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a href="https://github.com/abdisa38" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+251938890645" className="hover:text-primary transition">
                  0938890645
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 flex-shrink-0" />
                <a href="mailto:abdisaawel313@gmail.com" className="hover:text-primary transition">
                  abdisaawel313@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Send className="w-4 h-4 flex-shrink-0" />
                <a href="https://t.me/bdisa38" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition">
                  @bdisa38
                </a>
              </li>
            </ul>
        ...
        <div className="mt-6 pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <p>&copy; 2026 CTC Club Learning Platform. All rights reserved.</p>
